...
export default class Item extends Component {
  ...
  getItemClassName = (props = {}) => {
    return classNames(
      ...
      this.props.selected && [
        'rct-item--selected',
        this.canResizeLeft(this.props) && 'rct-item--selected-resize-left',
        this.canResizeRight(this.props) && 'rct-item--selected-resize-right',
      ],
  ...
  getCursorClassName = () => {
    ...
    if (this.canResizeRight(this.props) && this.state.dragging) {
      return 'rct-item--cursor-e-resize'
    }

    if (this.canResizeLeft(this.props) && this.state.dragging) {
      return 'rct-item--cursor-w-resize'
    }
    if (this.canMove(this.props)) {
      return 'rct-item--cursor-move'
    }
