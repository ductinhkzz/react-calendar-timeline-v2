...
class DateHeader extends React.Component {
  ...
  getHeaderData = memoize((intervalRenderer, style, className, getLabelFormat, unitProp, headerData) => {
    return {
      intervalRenderer,
      style,
      className,
...
function formatLabel([timeStart], unit, labelWidth, formatOptions = defaultHeaderFormats) {
  let format;
  if (labelWidth >= 150) {
