...
export default class Item extends Component {
  ...
  dragGroupDelta(e) {
    ...
    if (this.state.dragging) {
      ...
      for (let key of Object.keys(groupTops)) {
  ...
  getResizeProps = (props = {}) => {
    return {
      left: {
        ...
        className: clsx('rct-item-handler rct-item-handler-left rct-item-handler-resize-left', props.leftClassName),
        style: {
          ...leftResizeStyle,
          ...props.leftStyle,
        },
      ...
      right: {
        ...
        className: clsx('rct-item-handler rct-item-handler-right rct-item-handler-resize-right', props.rightClassName),
        style: {
          ...rightResizeStyle,
          ...props.rightStyle,
        },
      ...
      <TimelineStateConsumer>
        {({ getTimelineState }) => {
          return this.props.itemRenderer({
            ...
            timelineContext: getTimelineState(),
            itemContext,
