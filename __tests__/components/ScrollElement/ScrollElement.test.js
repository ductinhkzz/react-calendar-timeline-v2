...
xdescribe('ScrollElement', () => {
  describe('mouse event delegates', () => {
    let onDoubleClickMock, onMouseLeaveMock, onMouseMoveMock, onMouseEnterMock, onContextMenuMock, wrapper;
  ...
  describe('mouse drag', () => {
    ...
    it('scrolls left', () => {
      ...
      wrapper.find(scrollElementSelector).simulate('mousedown', mouseDownEvent).simulate('mousemove', mouseOverEvent);

      expect(wrapper.instance().scrollComponent.scrollLeft).toBe(originX + scrollDifference);
    });
  ...
  describe('mouse leave', () => {
    ...
    it('cancels dragging on mouse leave', () => {
      ...
      expect(wrapper.instance().scrollComponent.scrollLeft).toBe(initialScrollLeft);
    });
  });
  ...
  describe('scroll', () => {
    ...
    it('adds width to scrollLeft if scrollLeft is less than half of width', () => {
      ...
      expect(wrapper.instance().scrollComponent.scrollLeft).toBe(currentScrollLeft + width);
    });
