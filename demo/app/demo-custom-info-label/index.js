...
export default class App extends Component {
  ...
  handleItemDrag = ({ eventType, itemId, time, edge, newGroupOrder }) => {
    ...
    if (this.state.infoLabelTime !== infoLabelTime || this.state.infoLabelGroupTitle !== infoLabelGroupTitle) {
      this.setState({
        showInfoLabel: true,
        infoLabelTime,
        infoLabelGroupTitle,
  ...
  render() {
    ...
    const customInfoLabelMarkup = showInfoLabel ? (
      <CustomInfoLabel time={infoLabelTime} groupTitle={infoLabelGroupTitle} heading={infoLabelHeading} />
    ) : null;
