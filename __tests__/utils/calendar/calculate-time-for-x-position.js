...
describe('calculate time for x position', () => {
  it('calculates point in middle of timeline', () => {
    ...
    const actual = calculateTimeForXPosition(canvasStart, canvasEnd, canvasWidthInPixels, currentXPositionInPixels);
  ...
  it('calculates point in first quarter of timeline', () => {
    ...
    const expected = moment('2018-01-01').add(6, 'hour').valueOf();
  ...
  it('calculates point in latter quarter of timeline', () => {
    ...
    const expected = moment('2018-01-01').add(18, 'hour').valueOf();
